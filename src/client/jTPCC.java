...
public class jTPCC implements jTPCCConfig {
    ...
    private LongAdder terminalsStarted = new LongAdder();
    private LongAdder transactionCount = new LongAdder();
    private long sessionCount = 0;

    private LongAdder fastNewOrderCounter = new LongAdder();
    private long newOrderCounter = 0, sessionStartTimestamp,
            sessionEndTimestamp, sessionNextTimestamp = 0, sessionNextKounter = 0;
    ...
    public jTPCC() {
        ...
        if (databaseDriverLoaded) {
            try {
                ...
                if (newOrderWeightValue + paymentWeightValue + orderStatusWeightValue
                ...
                terminalsStarted.add(numTerminals);
                try {
    ...
    public void signalTerminalEnded(jTPCCTerminal terminal, long countNewOrdersExecuted) {
        ...
        if (terminalsStarted.longValue() == 0) {
